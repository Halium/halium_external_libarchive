...
BSDTAR_RECOVERY_SHARED_LIBRARIES :=
BSDTAR_RECOVERY_STATIC_LIBRARIES := libarchive libarchive_fe libz
BSDTAR_RECOVERY_INSTALL_TARGET := $(TARGET_RECOVERY_ROOT_OUT)/sbin
BSDTAR_RECOVERY_FORCE_STATIC := true
else
BSDTAR_RECOVERY_SHARED_LIBRARIES := libz
BSDTAR_RECOVERY_STATIC_LIBRARIES := libarchive libarchive_fe
BSDTAR_RECOVERY_INSTALL_TARGET := $(TARGET_RECOVERY_ROOT_OUT)/system/bin
BSDTAR_RECOVERY_FORCE_STATIC := false
endif
...
LOCAL_CFLAGS :=  -DBSDTAR_VERSION_STRING=ARCHIVE_VERSION_ONLY_STRING -DPLATFORM_CONFIG_H=\"$(libarchive_target_config)\"
LOCAL_SHARED_LIBRARIES := $(BSDTAR_RECOVERY_SHARED_LIBRARIES)
LOCAL_STATIC_LIBRARIES := $(BSDTAR_RECOVERY_STATIC_LIBRARIES)
LOCAL_SRC_FILES := $(bsdtar_src_files)
LOCAL_C_INCLUDES := $(LOCAL_PATH)/libarchive $(LOCAL_PATH)/libarchive_fe $(LOCAL_PATH)/contrib/android/include
LOCAL_MODULE_CLASS := RECOVERY_EXECUTABLES
LOCAL_MODULE_PATH := $(BSDTAR_RECOVERY_INSTALL_TARGET)
LOCAL_FORCE_STATIC_EXECUTABLE := $(BSDTAR_RECOVERY_FORCE_STATIC)
include $(BUILD_EXECUTABLE)
